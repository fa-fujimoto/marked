...
inline.color.start = edit$1(inline.color.start)
  .replace(/color/g, inline._color)
  .getRegex();
inline.color.middle = edit$1(inline.color.middle)
  .replace(/color/g, inline._color)
  .replace(/punctuation/g, inline._punctuation)
  .replace(/overlapSkip/g, inline._overlapSkip)
  .getRegex();
inline.color.end = edit$1(inline.color.end)
  .replace(/punctuation/g, inline._punctuation)
  .getRegex();
...
inline.termLink = edit$1(inline.termLink)
  .replace('label', inline._label)
...
inline.pedantic = merge$1({}, inline.normal, {
  ...
  termLink: edit$1(/^!?\!\{(term)\}\(\s*(label)?\s*\)/)
    .replace('label', inline._label)
    .replace('term', inline._term)
    .getRegex(),
